-- Lyno On Top , dsc.gg/lyno
print("Loaded (inf yield fixed wave executor supported)")
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			toClipboard("https://discord.io/infiniteyield")
...
function saves()
	if writefileExploit() then
		if pcall(function() game:HttpGet("https://raw.githubusercontent.com/NTDCore/ScriptPersonal/main/IYDefault.iy") end) then
			if game:HttpGet("https://raw.githubusercontent.com/NTDCore/ScriptPersonal/main/IYDefault.iy") ~= nil then
				local success, response = pcall(function()
					local json = HttpService:JSONDecode(game:HttpGet("https://raw.githubusercontent.com/NTDCore/ScriptPersonal/main/IYDefault.iy"))
